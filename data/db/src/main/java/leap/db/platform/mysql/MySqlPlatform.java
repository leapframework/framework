...
public class MySqlPlatform extends GenericDbPlatform {
	
	public MySqlPlatform() {
		this(DbPlatforms.MYSQL);
	}

	public MySqlPlatform(String type){
		super(type,productNameContainsIgnorecaseMatcher("mysql"));
	}
    ...
    protected GenericDbMetadataReader createMetadataReader(DatabaseMetaData jdbcMetadata) throws SQLException {
		return new MySql5MetadataReader();
    }
}