...
import leap.oauth2.web.token.WebAccessTokenStore;
import leap.web.App;
import leap.web.AppInitializable;
import leap.web.security.SecurityConfigurator;

@Configurable(prefix="oauth2.web")
public class DefaultOAuth2WebConfig implements OAuth2WebConfig, OAuth2WebConfigurator, AppInitializable {
    ...
    @Override
    public OAuth2WebConfigurator useJdbcAccessTokenStore() {
    ...
    public OAuth2WebConfigurator setEnabled(boolean enabled) {
    ...
    public OAuth2WebConfigurator setRemoteLogoutEnabled(boolean enabled) {
    ...
    public OAuth2WebConfigurator setUserAccessTokenEnabled(boolean userAccessTokenEnabled) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setClientId(String clientId) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setClientSecret(String clientSecret) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setClientRedirectUri(String uri) {
        this.clientRedirectUri = Paths.suffixWithoutSlash(uri);
        return this;
    }

    @Configurable.Property
    public OAuth2WebConfigurator setRemoteServerUrl(String url) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setRemoteTokenEndpointUrl(String url) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setRemoteAuthzEndpointUrl(String url) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setRemoteLogoutEndpointUrl(String url) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setErrorView(String errorView) {
    ...
    @Configurable.Property
    public OAuth2WebConfigurator setAccessTokenCookieName(String accessTokenCookieName) {
    ...
    public OAuth2WebConfigurator setAccessTokenStore(WebAccessTokenStore accessTokenStore) {
