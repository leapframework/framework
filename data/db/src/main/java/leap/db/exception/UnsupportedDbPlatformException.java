...
public class UnsupportedDbPlatformException extends DbException {
	...
	public UnsupportedDbPlatformException(String message) {
		super(message);
	}

	public UnsupportedDbPlatformException(Throwable cause) {
		super(cause);
	}

	public UnsupportedDbPlatformException(String message, Throwable cause) {
		super(message, cause);
	}
