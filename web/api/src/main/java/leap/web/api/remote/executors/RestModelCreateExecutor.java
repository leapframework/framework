...
public class RestModelCreateExecutor extends ModelExecutorBase implements ModelCreateExecutor {

    public RestModelCreateExecutor(ModelExecutorContext context) {
        super(context);
    }
