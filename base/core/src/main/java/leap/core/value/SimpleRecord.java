...
public class SimpleRecord extends LinkedHashMap<String, Object> implements Record {
	...
	public SimpleRecord(int initialCapacity) {
		super(initialCapacity);
	}

	public SimpleRecord(Map<? extends String, ? extends Object> m) {
		super(m);
	}

	public SimpleRecord(int initialCapacity, float loadFactor) {
