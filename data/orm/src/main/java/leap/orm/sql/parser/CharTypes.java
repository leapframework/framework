...
//A modified copy of com.alibaba.druid.sql.parser.CharTypes from <a href="https://github.com/alibaba/druid">durid</a>. 
class CharTypes {
    ...
    /**
     * used to scan parameter :  #parameter# $parameter$ :name
     */
    public static boolean isParameterChar(char c){
    	boolean r = isIdentifierChar(c);
