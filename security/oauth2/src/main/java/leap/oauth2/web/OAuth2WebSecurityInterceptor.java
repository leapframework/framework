...
import leap.oauth2.web.auth.OAuth2WebResponseHandler;
import leap.web.App;
...
public class OAuth2WebSecurityInterceptor implements SecurityInterceptor, AppInitializable {
    ...
    protected @Inject OAuth2WebResponseHandler[] handlers;
    ...
    protected void handleOAuth2ServerSuccess(Request request, Response response, OAuth2Params params) throws Throwable {
        ...
        for (OAuth2WebResponseHandler handler : handlers) {
