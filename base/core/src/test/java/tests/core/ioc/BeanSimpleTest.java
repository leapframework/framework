...
import tested.base.beans.IXMLAndAnnotationBean;
...
public class BeanSimpleTest extends CoreTestCase {
    ...
    @Test
    public void testNamedBeans() {
        Map<String, Cache> cacheBeans = factory.getNamedBeans(Cache.class);
        assertNotEmpty(cacheBeans);
        cacheBeans.put("new_cache", new SimpleLRUCache());
    }
