...
public class NestedUnsupportedEncodingException extends RuntimeException {
	...
	public NestedUnsupportedEncodingException(UnsupportedEncodingException cause) {
	    super(cause);
    }
	
	public NestedUnsupportedEncodingException(String message, UnsupportedEncodingException cause) {
	    super(message, cause);
    }
