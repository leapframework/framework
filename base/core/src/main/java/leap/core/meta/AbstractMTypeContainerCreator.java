...
public abstract class AbstractMTypeContainerCreator implements MTypeContainerCreator {
    ...
    @Override
    public MTypeContainerCreator setListener(MTypeListener listener) {
    ...
    @Override
    public MTypeContainerCreator setStrategy(MTypeStrategy strategy) {
    ...
    @Override
    public MTypeContainerCreator setAlwaysReturnComplexTypeRef(boolean b) {
        alwaysReturnComplexTypeRef = b;
        return this;
    }
