...
public class InvalidOptimisticLockException extends DataAccessException {
	...
	public InvalidOptimisticLockException(String message) {
		super(message);
	}

	public InvalidOptimisticLockException(Throwable cause) {
		super(cause);
	}

	public InvalidOptimisticLockException(String message, Throwable cause) {
		super(message, cause);
	}
