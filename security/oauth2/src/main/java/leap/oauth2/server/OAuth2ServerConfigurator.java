...
public interface OAuth2ServerConfigurator {
	...
	/**
	 * Returns the {@link OAuth2InMemoryStore} for configuration.
	 */
	OAuth2InMemoryStore inMemoryStore();
	...
	/**
	 * Use {@link OAuth2InMemoryStore} as client, code, token and sso store.
	 */
	...
	OAuth2ServerConfigurator setDefaultLoginSessionExpires(int seconds);
	
	OAuth2ServerConfigurator setClientStore(OAuth2ClientStore clientStore);
	
	OAuth2ServerConfigurator setCodeStore(OAuth2AuthzCodeStore codeStore);
