...
public abstract class ApiNamedWithDescBuilder<T extends ApiObject> extends MNamedWithDescBuilder<T> implements AttributeAccessor {

	protected Map<String, Object> attrs;
	
	public ApiNamedWithDescBuilder() {
        super();
    }
