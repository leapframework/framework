...
class DefaultValueStyler implements ValueStyler {
	...
	public String style(Object value) {
		if (value == null) {
			...
			return Classes.getShortName((Class) value);
		}
		else if (value instanceof Method) {
			Method method = (Method) value;
			return method.getName() + "@" + Classes.getShortName(method.getDeclaringClass());
		}
			...
			return styleArray(Objects2.toObjectArray(value));
		}
		else {
	...
	private String styleArray(Object[] array) {
		...
		result.append(ARRAY + "<").append(Classes.getShortName(array.getClass().getComponentType())).append(">[");
