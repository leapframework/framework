...
public interface OAuth2ResourceConfig {
	...
	/**
	 * Returns the {@link OAuth2ResourceScope} for the given path or <code>null</code>.
	 */
	OAuth2ResourceScope getScope(String path);
	
	/**
	 * Returns {@link OAuth2ResourcePath} for the given path or <code>null</code>.
	 */
	OAuth2ResourcePath getResourcePath(String path);
