...
public class RelationMapping {
    ...
    protected final String              onCascadeDeleteFilter;
    protected final boolean             autoGenerated;
    protected final JoinFieldMapping[]  joinFields;
    protected final boolean             nestedCreatable;
	...
	public RelationMapping(String name, RelationType type,
                           ...
                           String onCascadeDeleteFilter,
                           boolean autoGenerated, List<JoinFieldMapping> joinFields, boolean nestedCreatable) {
        ...
        if(embedded) {
            ...
            Args.notEmpty(inverseRelationName, name + ".inverseRelationName");
