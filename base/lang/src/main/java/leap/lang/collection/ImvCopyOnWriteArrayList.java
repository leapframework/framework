...
/**
 * An {@link CopyOnWriteArrayList} wraps the immutable view of itself.
 */
public class ImvCopyOnWriteArrayList<E> extends CopyOnWriteArrayList<E> implements ImvList<E>{
    ...
    public ImvCopyOnWriteArrayList(Collection<? extends E> c) {
        super(c);
    }

    public ImvCopyOnWriteArrayList(E[] toCopyIn) {
        super(toCopyIn);
    }

    public List<E> getImmutableView() {
        if(null == immutableView) {
            immutableView = Collections.unmodifiableList(this);
        }
