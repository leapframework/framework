...
public class OAuth2ResourcePath extends SecuredPath {
	
	protected final OAuth2ResourceScope scope;

	public OAuth2ResourcePath(PathPattern pathPattern,
							  boolean allowAnonymous, boolean allowClientOnly, boolean allowRememberMe,
							  SecuredRule[] rules, OAuth2ResourceScope scope) {
