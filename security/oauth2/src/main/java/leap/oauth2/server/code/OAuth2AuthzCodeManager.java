...
public interface OAuth2AuthzCodeManager {
    
    /**
     * Creates a new authorization code.
     */
    OAuth2AuthzCode createAuthorizationCode(OAuth2Authentication authc);
	 ...
	 */
	OAuth2AuthzCode consumeAuthorizationCode(String code);
