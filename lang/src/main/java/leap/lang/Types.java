...
public class Types {
	...
	public static TypeInfo getTypeInfo(Class<?> type,Type genericType) {
		...
		if(isSimpleType(type, genericType)){
			kind = MTypeKind.SIMPLE;
		}else if(isCollectionType(type, genericType)){
			kind = MTypeKind.COLLECTION;
			elementType     = getElementType(type, genericType);
			elementTypeInfo = getTypeInfo(elementType, null);
		}else{
    ...
    public static Class<?> getElementType(Class<?> type, Type genericType) throws IllegalStateException {
		if(!isCollectionType(type, genericType)){
	...
	public static Class<?>[] getActualTypeArguments(Type genericType){
		return getActualTypes(getTypeArguments(genericType));
	}
