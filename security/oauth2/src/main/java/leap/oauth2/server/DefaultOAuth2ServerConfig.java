...
public class DefaultOAuth2ServerConfig implements OAuth2ServerConfig, OAuth2ServerConfigurator, AppInitializable {
    ...
    protected @Inject                OAuth2InMemoryStore  inMemoryStore;
    protected @Inject                OAuth2ClientStore    clientStore;
    protected @Inject                OAuth2AuthzCodeStore codeStore;
    protected @Inject                OAuth2TokenStore     tokenStore;
    protected @Inject                OAuth2SSOStore       ssoStore;
    protected @Inject                SchedulerManager     schedulerManager;
    protected @Inject(name = "jdbc") OAuth2ClientStore    jdbcClientStore;
    protected @Inject(name = "jdbc") OAuth2AuthzCodeStore jdbcCodeStore;
    protected @Inject(name = "jdbc") OAuth2TokenStore     jdbcTokenStore;
    protected @Inject(name = "jdbc") OAuth2SSOStore       jdbcSSOStore;
	...
	@Override
    public OAuth2InMemoryStore inMemoryStore() {
    ...
    @Configurable.Property
    public OAuth2ServerConfigurator setDefaultLoginSessionExpires(int seconds){
    ...
    @Override
    public OAuth2ServerConfigurator setClientStore(OAuth2ClientStore store) {
        Args.notNull(store);
        this.clientStore = store;
        return this;
    }
    
    public OAuth2ServerConfigurator setCodeStore(OAuth2AuthzCodeStore store) {
        Args.notNull(store);
        this.codeStore = store;
        return this;
    }
    
    public OAuth2ServerConfigurator setTokenStore(OAuth2TokenStore store) {
        Args.notNull(store);
    ...
    @Override
    public OAuth2AuthzCodeStore getCodeStore() {
        if(null == codeStore) {
    ...
    @Override
    public OAuth2SSOStore getSSOStore() {
        if(null == ssoStore) {
