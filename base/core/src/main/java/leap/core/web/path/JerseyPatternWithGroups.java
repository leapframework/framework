 ...
 */
@Internal
public class JerseyPatternWithGroups {

    private static final int[] EMPTY_INT_ARRAY = new int[0];
    /**
     * The empty pattern that matches the null or empty string.
     */
    public static final JerseyPatternWithGroups EMPTY = new JerseyPatternWithGroups();
    /**
     ...
     */
    protected JerseyPatternWithGroups() {
        this.regex = "";
     ...
     */
    public JerseyPatternWithGroups(final String regex) throws PatternSyntaxException {
     ...
     *         regular expression could not be compiled
     */
    public JerseyPatternWithGroups(final String regex, final int[] groupIndexes) throws PatternSyntaxException {
     ...
     */
    public JerseyPatternWithGroups(final Pattern regexPattern) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if the regexPattern is null.
     */
    public JerseyPatternWithGroups(final Pattern regexPattern, final int[] groupIndexes) throws IllegalArgumentException {
    ...
    public final boolean matches(final CharSequence cs) {
        // Check for match against the empty pattern
        if (cs == null || regexPattern == null) {
            return false;
        }
        return regexPattern.matcher(cs).matches();
    }
    ...
    public final boolean equals(final Object obj) {
        ...
        final JerseyPatternWithGroups that = (JerseyPatternWithGroups) obj;
