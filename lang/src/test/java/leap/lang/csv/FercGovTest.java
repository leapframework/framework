...
public class FercGovTest {
    ...
    public void testContractFile() throws IOException {
        URL contractData = ClassLoader.getSystemClassLoader().getResource("csv/ferc.gov/contract.txt");
    ...
    public void testTransactionFile() throws IOException {
        URL transactionData = ClassLoader.getSystemClassLoader().getResource("csv/ferc.gov/transaction.txt");
