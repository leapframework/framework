...
public class DefaultOrmConfig implements OrmConfig,PostConfigureBean {
    ...
    protected String      queryFilterTag             = "query_filter";
    ...
    @Override
    public String getQueryFilterTag() {
        return queryFilterTag;
    }
    ...
    @ConfigProperty
    public void setQueryFilterTag(String queryFilterTag) {
        this.queryFilterTag = queryFilterTag;
    }
