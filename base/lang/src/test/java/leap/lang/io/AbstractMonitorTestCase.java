...
abstract class AbstractMonitorTestCase extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        FileFilter2 files 	   = FileFilters.isFile();
        FileFilter2 javaSuffix  = FileFilters.endsWith(".java");
        FileFilter2 fileFilter  = FileFilters.and(files, javaSuffix);
        FileFilter2 directories = FileFilters.isDirectory();
        FileFilter2 visible 	   = FileFilters.isVisible();
        FileFilter2 dirFilter   = FileFilters.and(directories, visible);
        FileFilter2 filter 	   = FileFilters.or(dirFilter, fileFilter);
