...
import static app.OAuth2TestData.PASS_ADMIN;
import static app.OAuth2TestData.PASS_XIAOMING;
import static app.OAuth2TestData.USER_ADMIN;
import static app.OAuth2TestData.USER_XIAOMING;
...
public class Global extends App {
    ...
    protected void initClients() {
        ...
        testClient.setId(Global.TEST_CLIENT_ID);
        testClient.setSecret(Global.TEST_CLIENT_SECRET);
        testClient.setGrantedScope(Global.TEST_CLIENT_GRANTED_SCOPE);
        testClient.setRedirectUri(Global.TEST_CLIENT_REDIRECT_URI);
        testClient.create();
