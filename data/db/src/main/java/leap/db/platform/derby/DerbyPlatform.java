...
public class DerbyPlatform extends GenericDbPlatform {
	...
	public DerbyPlatform(){
		super(DbPlatforms.DERBY,productNameContainsIgnorecaseMatcher("Derby"));
	}

	public DerbyPlatform(String type){
		super(type,productNameContainsIgnorecaseMatcher("Derby"));
	}
