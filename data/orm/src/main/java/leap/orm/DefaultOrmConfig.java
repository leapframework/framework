...
public class DefaultOrmConfig implements OrmConfig, PostConfigureBean, BeanFactoryAware {
    ...
    protected boolean     autoMappingTableWithAcronym = false;
    protected boolean     eventsDefaultEnabled        = true;
    protected boolean     convertPropertyForReadMap   = false;
    protected boolean     convertFieldForJoin         = false;
    protected boolean     readByQueryView             = true;
    ...
    @Override
    public boolean isConvertFieldForJoin() {
        return convertFieldForJoin;
    }

    @Override
    public boolean isReadByQueryView() {
        return readByQueryView;
    }
    ...
    @Override
    public boolean isAutoMappingTableWithAcronym() {
        return autoMappingTableWithAcronym;
    }

    @ConfigProperty
    public void setAutoMappingTableWithAcronym(boolean autoMappingTableWithAcronym) {
        this.autoMappingTableWithAcronym = autoMappingTableWithAcronym;
    }

    @Override
    public boolean isConvertPropertyForReadMap() {
        return convertPropertyForReadMap;
    }
    ...
    @ConfigProperty
    public void setConvertFieldForJoin(boolean convertFieldForJoin) {
        this.convertFieldForJoin = convertFieldForJoin;
    }

    @ConfigProperty
    public void setReadByQueryView(boolean readByQueryView) {
        this.readByQueryView = readByQueryView;
    }
