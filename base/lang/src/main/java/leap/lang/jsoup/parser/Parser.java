...
/**
 * Parses HTML into a {@link leap.lang.jsoup.nodes.Document}. Generally best to use one of the  more convenient parse methods
 * in {@link leap.lang.jsoup.Jsoup}.
 */
public class Parser {
    ...
    public static Document parse(String html, String baseUri, HtmlParseMode parseModel) {
        TreeBuilder treeBuilder = new HtmlTreeBuilder(parseModel);
        return treeBuilder.parse(html, baseUri, ParseErrorList.noTracking());
    }
