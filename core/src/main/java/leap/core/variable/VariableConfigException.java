...
public class VariableConfigException extends AppConfigException {
	...
	public VariableConfigException(String message) {
		super(message);
	}

	public VariableConfigException(Throwable cause) {
		super(cause);
	}

	public VariableConfigException(String message, Throwable cause) {
		super(message, cause);
	}
