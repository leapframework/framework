...
import leap.web.captcha.cage.image.ConstantColorGenerator;
import leap.web.captcha.cage.image.EffectConfig;
import leap.web.captcha.cage.image.Painter;
import leap.web.captcha.cage.image.ScaleConfig;
import leap.web.captcha.cage.token.RandomCharacterGeneratorFactory;
 ...
 * @author akiraly
 */
public class YCage extends leap.web.captcha.cage.Cage {
	/**
