...
public class RelationMappingBuilder implements Buildable<RelationMapping> {
    ...
    protected String          joinRelationName;
    protected String          joinTargetRelationName;
    ...
    protected boolean         allowSelfReference;
    ...
    public void setJoinRelationName(String joinRelationName) {
    ...
    public void setJoinTargetRelationName(String joinTargetRelationName) {
    ...
    public RelationMapping build() {
	    ...
	    return new RelationMapping(name, type, inverseRelationName, joinRelationName, joinTargetRelationName,
                                   targetEntityName, joinEntityName,
                                   isOptional(), logical, virtual, remote,
                                   embedded, embeddedFileName,
                                   onCascadeDelete, onCascadeDeleteFilter, autoGenerated, joinFields,
                                   nestedCreatable, allowSelfReference);
    }
