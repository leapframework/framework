...
public class HtmlAttrProcessor extends AbstractNamedAttrProcessor {
	
	public static final String ATTR_NAME = "html";

	public HtmlAttrProcessor() {
		super(ATTR_NAME);
	}
    ...
    public Node processStartElement(HtplEngine engine, HtplDocument doc, Element e, Attr attr) {
		...
		e.setChildNode(new Text(attr.getString(),Type.HTML));
	    return e;
    }
