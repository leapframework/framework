...
public class InvalidFormatContentException extends AppException {
	...
	public InvalidFormatContentException(String message) {
		super(message);
	}

	public InvalidFormatContentException(Throwable cause) {
		super(cause);
	}

	public InvalidFormatContentException(String message, Throwable cause) {
		super(message, cause);
	}
