...
public class DefaultOAuth2ServerErrorHandler implements OAuth2ServerErrorHandler {
    
    private static final Log log = LogFactory.get(DefaultOAuth2ServerErrorHandler.class);
