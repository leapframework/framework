...
public class CallableStatementProxy<T extends ConnectionProxy> extends PreparedStatementProxy<T> implements CallableStatement {

    protected final CallableStatement cs;

    public CallableStatementProxy(T connection, CallableStatement stmt, String sql) {
        this(connection, stmt, sql, false);
    }

    public CallableStatementProxy(T connection, CallableStatement stmt, String sql, boolean stackTrace) {
        super(connection, stmt, sql, stackTrace);
        this.cs = stmt;
    }
